...
export default function PassengerPickup({ ride, onStartTrip, busy }) {
  return (
    <DriverShell rightSlot={
      ...
      <div className="body">
        ...
        <button className="btn rise-3" onClick={onStartTrip} disabled={busy} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
