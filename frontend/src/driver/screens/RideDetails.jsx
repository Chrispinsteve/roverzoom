...
export default function RideDetails({ ride, onBack, onStartNavigation, busy, error }) {
  return (
    <DriverShell onBack={onBack}>
      <div className="body">
        ...
        <button className="btn rise-3" onClick={onStartNavigation} disabled={busy} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
